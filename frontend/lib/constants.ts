export const ZONE_META: Record<string, { label: string; shortLabel: string }> = {
  ...
  P1:     { label: "Platform 1",         shortLabel: "P1" },
  P2:     { label: "Platform 2",         shortLabel: "P2" },
  P3:     { label: "Platform 3",         shortLabel: "P3" },
  P4:     { label: "Platform 4",         shortLabel: "P4" },
  P5:     { label: "Platform 5",         shortLabel: "P5" },
  P6:     { label: "Platform 6",         shortLabel: "P6" },
};
